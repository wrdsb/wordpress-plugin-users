...
function create_wrdsb_rest_routes() {
	...
	$controller->register_routes();
	$controller = new WRDSB_REST_Blog_User_by_Email_Controller;
	$controller->register_routes();
	$controller = new WRDSB_REST_Blog_User_by_Username_Controller;
	$controller->register_routes();
	$controller = new WRDSB_REST_Blog_User_by_ID_Number_Controller;
	$controller->register_routes();
}
